 ...
 * @author luis_
 */
@WebServlet(name = "ListarAlumnosController", urlPatterns = {"/ListarAlumnosController"})
public class ListarAlumnosController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Alumno> listaAlumno = new MantAlumnoDAO().ListarAlumnos();
        request.setAttribute("lstalumnos", listaAlumno);
